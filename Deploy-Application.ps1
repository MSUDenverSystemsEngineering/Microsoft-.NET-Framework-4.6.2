...
Try {
	...
	[string]$appVersion = '4.6.2'
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '03/14/2017'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		$exitCode = Execute-Process -Path "NDP462-KB3151800-x86-x64-AllOS-ENU.exe" -Parameters "/q /norestart" -WindowStyle "Hidden" -PassThru -WaitForMsiExec
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		$exitCode = Execute-Process -Path "NDP462-KB3151800-x86-x64-AllOS-ENU.exe" -Parameters "/uninstall /q /norestart" -WindowStyle "Hidden" -PassThru -WaitForMsiExec
		If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) {
			$mainExitCode = $exitCode.ExitCode
		}
		##*===============================================
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDlztPucypK8LF2
# HkZQQVrDKV9mOdPGRtcargBoqMZ76qCCD4cwggQUMIIC/KADAgECAgsEAAAAAAEv
...
# gAAwGQYJKoZIhvcNAQkDMQwGCisGAQQBgjcCAQQwLwYJKoZIhvcNAQkEMSIEIHvb
# JEFY0DxA+OGFvmMLR4slGvJMm7yVHuOGmslkLlj0MA0GCSqGSIb3DQEBAQUABIIB
# AHkuTF4tcmsxqGgdyt23jv6OETFRCZQvTSErCW7LnimYz0itFB31+j3xbtumRow6
# RcMaBOOWCmfaGEdokK7c+ddr/IFAz9lZnIt8K2nQ3K+sj+CDrWpZy6Pf0cL/yEWh
# LHljN3RPqif0b0gCaUK/+Y+4fU+kC3blAt2zNcV2xOEHmQ1EVTWnOtEwzNvwrkLK
# XYxNMZrsF3K8wc8oof6MqRDrtcZUzwSC/ztyP5/GhlipIsv0RU0typB6h6jijqjN
# N7h6Ud5gwxaSt8wjNJORJ9sbpWXZ0hAQjuzTFWtpLz7Akf8SoZoUs4Y2b2JhNQUP
# qFMx+Phe8wwfeidYmqaG6bahggKiMIICngYJKoZIhvcNAQkGMYICjzCCAosCAQEw
...
# ATAcBgkqhkiG9w0BCQUxDxcNMTcwMzE0MjAyOTE5WjAjBgkqhkiG9w0BCQQxFgQU
# wNKEYAjw1KqKDv66gFsQsUyovuowgZ0GCyqGSIb3DQEJEAIMMYGNMIGKMIGHMIGE
...
# AQUABIIBAJxvct76qpGR7t5EnszuUExE9OdRBHqq3IuDfhXkY5RFcGTkWBIyYxq2
# JmOi137hAnow2c4WQvfGAT52B7Ac+5nAKz9LAE2BegXkYwCGKQqep057MOUjSc0B
# 7l0kWvcRLRKoee/ZFryWThPojK7JlmAffttf0DehjwHEBPDPCF9idyIf6ydVIIwl
# eV6diCL+rbqo4s6sb2vyWfZZDxeAqDh2yklCxcXLTYnadwsLxddLUj23UJCnlSi1
# QmNzjj+vpF7K87023LP8bbiyvxFmTLbAGfqwJsMPH4NyMc2fqh4GfLpK1oe+v5wF
# 4HnC+83Z9QmjQ81e5RAkv7b5jwqCckI=
